...
caverns = Area('Underground Caverns', children=[
    ...
    Area('Upper Caverns', access_rules=['jewelofopen', 'open_no4,$canFly'], children=[
        ...
        Area('Ice Area', children=[
            normal.simple_location('Underwater Item 1', 38, 37, access_rules=['holysymbol'], visibility_rules=['logic_equipment'], location_id=143),
            normal.simple_location('Underwater Item 2', 40, 37, access_rules=['holysymbol'], visibility_rules=['logic_full'], location_id=144),
            normal.simple_location('On Alcove', 43, 36, access_rules=['mermanstatue', '$canFly'],
                                   visibility_rules=['logic_equipment'], location_id=142),
            normal.simple_location('Underwater Item 3', 50, 37, access_rules=['holysymbol,mermanstatue'],
